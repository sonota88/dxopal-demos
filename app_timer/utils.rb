...
def register_se_ring
  ...
  SoundEffect.register(:se_ring, 1000, WAVE_TRI) do
    ...
    if    msec < interval * 1 then [880, vol]
    elsif msec < interval * 2 then [880, 0]
    elsif msec < interval * 3 then [880, vol]
    elsif msec < interval * 4 then [880, 0]
    elsif msec < interval * 5 then [880, vol]
    elsif msec < interval * 6 then [880, 0]
    elsif msec < interval * 7 then [880, vol]
    elsif msec < interval * 8 then [880, 0]
    else
      [880, 0]
    end
  end
